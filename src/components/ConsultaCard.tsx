 ...
 * → Manutenção: Mudanças no visual do card acontecem em src/styles/consultaCard.styles.ts
...
// Os estilos deste componente moram em um arquivo separado (aparencia pura)
